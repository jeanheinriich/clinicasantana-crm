...
export default async function MetaIntegracaoPage({
  ...
  const authUrl = metaAppId
    ? `https://www.facebook.com/v21.0/dialog/oauth?client_id=${metaAppId}&redirect_uri=${encodeURIComponent(`${baseUrl}/api/integracoes/meta/callback`)}&scope=ads_read,pages_read_engagement,instagram_basic,instagram_manage_insights&response_type=code`
    : null
